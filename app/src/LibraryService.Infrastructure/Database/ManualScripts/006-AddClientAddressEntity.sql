...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260303134358_AddClientAddressEntity') THEN
...
BEGIN
    ...
    VALUES ('20260303134358_AddClientAddressEntity', '8.0.11');
    END IF;
END $EF$;
COMMIT;
