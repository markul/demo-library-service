...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260226095147_AddClientAddresses') THEN
...
BEGIN
    ...
    VALUES ('20260226095147_AddClientAddresses', '8.0.11');
    END IF;
END $EF$;
COMMIT;
