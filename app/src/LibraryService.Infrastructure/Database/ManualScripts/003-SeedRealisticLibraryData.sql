...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260213071851_SeedRealisticLibraryData') THEN
...
BEGIN
    ...
    VALUES ('20260213071851_SeedRealisticLibraryData', '8.0.11');
    END IF;
END $EF$;
COMMIT;
